...
namespace M.YZ.Basement.Messaging.MessageBus.RabbitMq;
public class RabbitMqReceiveMessageBus : IReceiveMessageBus, IDisposable
{
    ...
    public RabbitMqReceiveMessageBus(ILogger<RabbitMqReceiveMessageBus> logger, BasementConfigurationOptions configuration, IServiceScopeFactory serviceScopeFactory, IMessageConsumer messageConsumer)
    {
        _logger = logger;
